                    ...
                    (function (u, v) {
                        if (response.message && !response.message.error) {
                            ...
                            if (configuration && configuration.activity) {
                                ...
                                console.log((j==1 ? (info.rule.initialDelay) * 1000 : info.rule.delayNotification ? (randomDelayTime * 1000) :(((info.rule.displayTime + info.rule.delayBetween + 3) * (v)) * 1000)), "@@@@@@@@@@@@@@@@@@@@@@@2")
                            //     if (j == 1) {
                            //         randomDelayTime = 0;
                            ...
                            //      }, (info.rule.delayNotification ? (randomDelayTime * 1000) : v==2 ? (info.rule.displayTime + info.rule.delayBetween + 4 + v*v)*1000   : (((info.rule.displayTime + info.rule.delayBetween + 3) * (v-1)) * 1000) * 2));
                                
                            
                            // // console.log(v,"--------------------", (info.rule.delayNotification ? (randomDelayTime * 1000) : v==2 ? (info.rule.displayTime + info.rule.delayBetween + 4 + v*v)*1000   : ((info.rule.displayTime + info.rule.delayBetween + 3) * (v-1)) * 1000), "@@@@@@@@@@@@@@@@2")
                            // }
