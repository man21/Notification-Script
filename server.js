    ...
    fs.readFile(path.resolve(__dirname, `${KEY}`), "utf8", (err, data) => {
      ...
      fetch(JSON_API)
        ...
        .then(async (body) => {
          ...
          let newLines = `${variableLine[0]}= ${JSON.stringify([
            JSON.parse(body),
          ])};`;
...
mongoose.connect(
  "mongodb+srv://admin_abc:admin_abc@tehcollegeplacement-an6dx.mongodb.net/cookie?retryWrites=true&w=majority",
  {
