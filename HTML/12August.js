...
var Note = function Note(config, containerStyle, iconStyle) {
    ...
    //     bulkNotificationFirstText.style.color= background-color: #f3f7ff
       ...
       //  bulkNotificationFirstText.innerHTML = '11111  ' //numberOfUsers + "123 " // + configuration.visitorText
        ...
        announcementNotificationImage.setAttribute('src', configuration.panelStyle.image ? configuration.panelStyle.image : 'https://cdn.zeplin.io/5de290feb524497c4a9c9959/assets/C77C11F2-0E34-49DE-97CC-10DF6C848B69.png')
