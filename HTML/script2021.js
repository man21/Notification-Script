...
async function loopThroughSplittedNotifications(splittedUrls, enableLoopNotification, notificationPath, config) {
    ...
    newDesignCSS.href = 'https://storage.googleapis.com/influence-197607.appspot.com/new-design.css';
        ...
        const bucketUrl = "https://s3.wasabisys.com/insidescript.com/maps/"
            ...
            var recentName = userDetails && userDetails ? userDetails.username ? userDetails.username : userDetails.response.json.value.form.firstname : null;
                ...
                finalResult.res_name = userDetails && userDetails ?
                    userDetails.city && userDetails.region && userDetails.country && recentName && !configuration.isHideFullLocation ?
                        `${recentName} ${(!configuration.isHideCityLocation || !configuration.isHideState || !configuration.isHideCountryLocation) ? configuration && configuration.recentText1 ? configuration.recentText1 : 'from' : ''} ${!configuration.isHideCityLocation ? userDetails.city : ''} ${(!configuration.isHideCityLocation && !configuration.isHideCountryLocation) || (!configuration.isHideCityLocation && !configuration.isHideState) ? ', ' : ''} ${!configuration.isHideState ? userDetails.region : ''} ${(!configuration.isHideState && !configuration.isHideCountryLocation)  ? ', ' : ''} ${!configuration.isHideCountryLocation ? userDetails.country : ''}`
                        :
                        userDetails.city && recentName && !configuration.isHideFullLocation && !configuration.isHideCityLocation?
                            ...
                            :
                            userDetails.region && recentName && !configuration.isHideFullLocation && !configuration.isHideState?
                                `${recentName} ${configuration && configuration.recentText1 ? configuration.recentText1 : 'from'} ${userDetails.region}`
                                :
