...
var CookieFunc = function (config) {
    ...
    response = {
        "data":{
           "initialPolicies":[
              {
                 "id":"pol:db85bf5d-97ad-49a9-825d-172e35a6ceb1",
                 "version":"1.0.0",
                 "slug":"essential",
                 "name":"Essential",
                 ...
                 "providers":[
                    {
                       "id":"pdr:302084c2-c031-4cf0-bda3-0233cf18b1a4",
                       "name":"tywmp.activehosted.com",
                       "privacyUrl":null,
                       "referenceId":",tywmp.activehosted.com"
                    }
                 ]
              },
              {
                 "id":"pol:bf918ce3-b9d1-4346-a4a5-6d304d843d51",
                 "version":"2.0.0",
                 "slug":"chat",
                 "name":"Live Chat",
                 ...
                 "providers":[
                    {
                       "id":"pdr:8d68ebd7-17bc-4726-a41d-69d250d2e8e4",
                       "name":"cdn.dashly.app",
                       "privacyUrl":null,
                       "referenceId":",cdn.dashly.app"
                    }
                 ]
              }
           ],
           "appearance":{
              ...
              "language":"en",
              "outlineDeclineButton":false,
              "position":"bottom-left",
              "project_id":"prj:5decc90f-012f-4579-b498-d6e1e09591f1",
              "removeBrandingTopLevel":false
           }
        }
     }
     ...
     if(response.data.appearance){
        ...
        var containerStyle = `
        border: ${0}px solid rgb(${200}, ${200}, ${200}, ${0.8});
        border-radius: ${9}px;
        background-color: rgb(${255}, ${255}, ${255}, ${1});
        box-shadow: rgb(0, 0, 0) ${0}px ${0}px ${0}px;
       ...
       // var enableLoopNotification = response.find(obj=> obj.rule.loopNotification) ? true : false
        ...
        // var disabledOnMobile =  response.find(obj=> obj.rule.hideNotification);
        //     if ((notificationPath.indexOf(__pathname) != -1 || notificationPath.indexOf(window.location.pathname) != -1 || response.find(obj=> obj.rule.displayOnAllPages)) &&  !(isMobile && disabledOnMobile)) {
        //         loopThroughSplittedNotifications( notificationPath, config);
        //     }
...
function CookieFn() {
   ...
   function notificationDisplay(type, config, containerStyle, iconStyle, alignment) {
        ...
        container.style =  "z-index: 99999999999; position: fixed; bottom: 5px; left: 5px; " //alignment;
        var innerContainer = document.createElement('div');
        innerContainer.setAttribute("id", "FPqR3tRBqJeA3tRB7MM9_0");
        var innerDiv = document.createElement('div');
        var mainContainer = document.createElement('div');
