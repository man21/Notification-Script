                                ...
                                if (j == 1) {
                                    ...
                                    setTimeout(function () {
                                        ...
                                        if(isTabVisibility){
                                           ...
                                           return notificationTimeout(u, info, info.rule, key, notificationPath); }
                                        }, (info.rule.delayNotification ? (randomDelayTime * 1000) : (((info.rule.displayTime + info.rule.delayBetween + 3) * (v-1)) * 1000) == 15  ? 10000 : ((info.rule.displayTime + info.rule.delayBetween + 3) * (v-1)) * 1000 ));
