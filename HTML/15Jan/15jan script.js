...
var influenceScript = 'influence-analytics.js';
...
var Note = function Note(config, containerStyle, iconStyle) {
    ...
    function notificationDisplay(type, config, containerStyle, iconStyle, alignment) {
        ...
        if (userDetails && userDetails) {
            if (userDetails.productImg) {
                ...
                if (userDetails.city && userDetails.country) {
                    ...
                    res_img = `https://image.maps.ls.hereapi.com/mia/1.6/mapview?co=${userDetails.country}&z=10&ci=${userDetails.city}&h=200&w=200&apiKey=BtlhAWSQDAWKsXz27TCSR7mcHAnEawJNUMWDGWwbo0M`;
                }
                    ...
                    res_img = `https://image.maps.ls.hereapi.com/mia/1.6/mapview?z=10&ci=${userDetails.city}&h=200&w=200&apiKey=BtlhAWSQDAWKsXz27TCSR7mcHAnEawJNUMWDGWwbo0M`;
                }
                    ...
                    res_img = `https://image.maps.ls.hereapi.com/mia/1.6/mapview?co=${userDetails.country}&z=10&h=200&w=200&apiKey=BtlhAWSQDAWKsXz27TCSR7mcHAnEawJNUMWDGWwbo0M`;
                }
            }
        ...
        if(configuration.panelStyle.secondaryColor){
            notifRecentContentII.style = `color: rgb(${configuration.panelStyle.secondaryColor.r},${configuration.panelStyle.secondaryColor.g},${configuration.panelStyle.secondaryColor.b});`
           }
