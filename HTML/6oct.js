...
var Note = function Note(config, containerStyle, iconStyle) {
    ...
    if(fromAppType == 'google'){
        ...
        reviewNotificationFooterLogo.className = 'bXZsh24SLi'
        reviewNotificationFooterLogo.setAttribute('src', userReview ? "https://s3.wasabisys.com/influencelogo/dashimages/f_logo_RGB-Blue_58.png" :"")
