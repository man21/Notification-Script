...
var Note = function Note(config, containerStyle, iconStyle) {
   ...
   // console.log(userReview,"USER REVIEW********")
    ...
    //console.log(userReview.review_text, "REVIEW TEXT")
       reviewNotificationUpperSecondaryText.innerHTML = "hello" //userReview.review_text  //configuration.gglReviewText ? configuration.gglReviewText : 'Reviewed us on Google';         //"Awesome must have tool for every marketer or an online business! Easy to use, great uxui, and most importantly - gets more leads than any other platform."
