...
var checkCampaignActive = function (config, cb) {
    var url = BASE_URL + '/campaign/track/' + "INF-10kjj0khjxqy4hww" //config;
...
var Notifications = function (config) {
    ...
    this.config = config;
    var rule;
    var rulesUrl = BASE_URL + '/rules/configuration/path/' + "INF-10kjj0khjxqy4hww" //config;
...
async function loopThroughSplittedNotifications(splittedUrls, enableLoopNotification, notificationPath, config) {
    ...
    let responseNotif = (callback) => {
        ...
        splittedUrlsSingle.map(async notifName => {
             ...
             var url = BASE_URL + '/elasticsearch/search/' + "INF-10kjj0khjxqy4hww" + '?type=' + notifName;
        ...
        if (userDetails && userDetails) {
            if (userDetails.productImg) {
                ...
                if (userDetails.city && userDetails.country) {
                    res_img = `https://image.maps.cit.api.here.com/mia/1.6/mapview?app_id=nzHFAV2TJG0WvAiqlCOX&app_code=WVfDqzVHbefu_cuipVASZw&ci=${userDetails.city}&co=${userDetails.country}&z=10&h=200&w=200`;
                    ...
                    res_img = `https://image.maps.cit.api.here.com/mia/1.6/mapview?app_id=nzHFAV2TJG0WvAiqlCOX&app_code=WVfDqzVHbefu_cuipVASZw&ci=${userDetails.city}&z=10&h=200&w=200`;
                    ...
                    res_img = `https://image.maps.cit.api.here.com/mia/1.6/mapview?app_id=nzHFAV2TJG0WvAiqlCOX&app_code=WVfDqzVHbefu_cuipVASZw&co=${userDetails.country}&z=10&h=200&w=200`;
