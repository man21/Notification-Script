...
async function loopThroughSplittedNotifications(splittedUrls, enableLoopNotification, notificationPath, config) {
    ...
    responseNotif((err, result, config) => {
        ...
        console.log(splittedUrls.length, "$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$")
...
var Note = function Note(config, containerStyle, iconStyle) {
        ...
        if (userDetails && userDetails) {
            if (userDetails.productImg) {
                ...
                if (userDetails.city && userDetails.country) {
                    ...
                    // res_img = `https://image.maps.ls.hereapi.com/mia/1.6/mapview?co=${userDetails.country}&z=10&ci=${userDetails.city}&h=200&w=200&apiKey=tcQAxZBR6qjzfFG817u_DJQrCNyvTnYDr2y-5A4J0ak`;
                }
                    ...
                    // res_img = `https://image.maps.ls.hereapi.com/mia/1.6/mapview?z=10&ci=${userDetails.city}&h=200&w=200&apiKey=tcQAxZBR6qjzfFG817u_DJQrCNyvTnYDr2y-5A4J0ak`;
                }
                    ...
                    // res_img = `https://image.maps.ls.hereapi.com/mia/1.6/mapview?co=${userDetails.country}&z=10&h=200&w=200&apiKey=tcQAxZBR6qjzfFG817u_DJQrCNyvTnYDr2y-5A4J0ak`;
                }
            }
    ...
    //     liveNotificationImageContainer.appendChild(liveNotificationImage)
        ...
        console.log(liveVisitorCount, "!!!!!!!!!!!!!!!1")

        console.log(liveVisitorCount == 0 ? 1 : liveVisitorCount, "@@@@@@@@@@@@@@@@@@@@@@@@@@@22")
    ...
    //     bulkNotificationFirstText.style.color= background-color: #f3f7ff
       ...
       //  bulkNotificationFirstText.innerHTML = '11111  ' //numberOfUsers + "123 " // + configuration.visitorText
        ...
        var announcementContainer= document.createElement('div');
         ...
         announcementContainer.style = type == 'announcement' ? "display:none" : "display:none";
