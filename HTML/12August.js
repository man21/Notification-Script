                        ...
                        if (response.message && !response.message.error) {
                            ...
                            if (configuration && configuration.activity) {
                                ...
                                if (j == 1) {
                                 ...
                                 },(info.rule.delayNotification ? (randomDelayTime * 1000) : v==1 ? ((info.rule.displayTime +  info.rule.delayBetween) *1000)  : ((info.rule.displayTime + info.rule.delayBetween + 3) * (v-1)) * 1000));
